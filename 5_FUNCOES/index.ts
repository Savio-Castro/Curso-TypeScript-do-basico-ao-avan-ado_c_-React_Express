...
function unirObjetos <U ,T>(obj1:U, obj2:T){
    return{
        ...obj1,
        ...obj2
    }
...
function  juntarArray<T>(arr1:T[],arr2:T[]){
    return arr1.concat(arr2)
}

console.log(juntarArray([1,2,3],[4,5]))
console.log(juntarArray<number|string>([1,2,3],["teste","testando"]))
...
function mostrarDetalhesProduto({nome, preco}: {nome:string, preco:number}):string|number{
